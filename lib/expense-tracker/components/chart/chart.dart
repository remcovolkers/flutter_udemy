...
import 'package:flutter_udemy/expense-tracker/components/chart/chart_bar.dart';
...
import 'package:flutter_udemy/expense-tracker/models/expense_bucket.dart';
                ...
                .map(
                  (bucket) => Expanded(
                    child: Padding(
                      ...
                      child: Icon(
                        expenseIcons[bucket.expenseCategory],
                        color: isDarkMode
